...
def table_init1():
    ...
    data1 = [
    ('001','未雨','女','19840410','総務','20060401',""), 
    ('002','美貴', '女', '19850620','営業','20070401',""), 
    ('003','江頭', '男', '19900810','情報システム','20070401',""), 
    ('004','知佳', '女', '19830521','経理','20100401','001'), 
    ('005','茶路', '男', '20000131','情報システム','20200401','003'),
    ('006','めぐ美', '女', '19971203','営業','20200401','002')]
